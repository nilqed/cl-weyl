...
(make::adjust-version-numbers Weyl "1.5")
...
(defclass ge-application (general-expression)
  ((funct :initarg :funct               ; The function being applied
          :accessor funct-of)
   (args :initarg :args                 ; Arguments to the function
         :accessor args-of)))
