...
(make::adjust-version-numbers Weyl "1.7")

#|  Classes used in this file but defined elsewhere |
...
(defmethod times ((num (or number numeric)) (func sampled-function))
  (map 'sampled-function #'(lambda (x) (* x num)) func))

(defmethod times ((func sampled-function) (num (or number numeric)))
  (map 'sampled-function #'(lambda (x) (* x num)) func))

(defmethod quotient ((func sampled-function) (num (or number numeric)))
  (map 'sampled-function #'(lambda (x) (/ x num)) func))
