...
;;; Fri Jan  1 00:25:09 1993 by Mark Kantrowitz <mkant@GLINDA.OZ.CS.CMU.EDU>
;;; metering.lisp -- 55421 bytes
...
(defparameter *metering-version* "v2.0 01-JAN-93"
...
#-(or :cmu :lcl3.0 :lcl4.0 :mcl1.3.2 :mcl :excl) 
(progn
 (eval-when (compile eval)
   (warn
