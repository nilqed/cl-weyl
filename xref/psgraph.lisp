...
#+(and :cltl2 (or (and :excl :allegro-v4.0) :mcl))
(defpackage "PSGRAPH" (:use "COMMON-LISP"))
#+(and :cltl2 (not (or (and :excl :allegro-v4.0) :mcl)))
(unless (find-package "PSGRAPH")
  (make-package "PSGRAPH" :use '("COMMON-LISP")))
...
;;; You may have to change the CLOS:: to PCL::
