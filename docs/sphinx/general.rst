...
We can always try the `describe` function to get information on an object:
...
Most functions also provide a documentation string which can be read by the
...
.. function::  get-variable-property domain var key               [FUNCTION]                        
...
where `get-variable-property` is looking for. As explained above, the 
information is fetched from the domain property list.
...
.. function:: depends-on? exp &rest vars                                [FUNCTION]
...
.. function:: different-kernels exp list-of-kernels   
...
.. function:: print-object exp stream                                           
...
.. function:: display expr &optional (stream *standard-output*)                  
...
.. function:: ge-equal x y                        [FUNCTION]                                        
...
.. function:: ge-great x y                    [FUNCTION]                                            
...
The function `WEYL::GE-GREAT` is undefined, we have to use `weyli`:
...
.. function::  def-ge-operator operator &rest keyword-expr-pairs                 [Function]
...
.. function:: deriv exp var &rest vars                                          [Function]
...
.. function:: nargs-of abstract-function                                        [Function]
...
.. function:: funcall fun arg1 arg2 ... argn                                   [Function]
...
.. function:: apply fun arg1 arg2 : : : argn list                                [Function]
...
.. function:: funct-of application                                              [Function]

   Returns the ge-function in the functional position of application.



.. function:: args-of application                                               [Function]
...
.. function::  declare-derivative func args &body body                  [Function]
...
.. function:: make-applicable-function args body                                [Function]
...
.. function:: deriv function integer1 integer2 ...                              [Function]
...
.. function:: substitute value var expr &rest ignore     [FUNCTION]
