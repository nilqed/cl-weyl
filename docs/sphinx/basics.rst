...
.. function:: super-domains-of domain                               [Generic]
...
.. function::  make-morphism domain mapping range &key (replace? T)  [Generic]
...
.. function::   get-morphisms &key domain range                     [Function]
...
.. function::    coerce element domain                               [Generic]

   Coerce an element to be a member of domain.
...
.. function:: weyli::binary= x y                                     [Generic]
...
::
;;
.. function::    weyli::times x y                                    [Generic]
...
.. function:: %times &rest args                                     [Generic]
...
;;
.. function::   one semigroup                                       [Generic]

   Returns the multiplicative identity of monoid.

.. function::   1? elt                                              [Generic]
...
.. function ::  weyli::plus x y                                    [Function]
...
;;
;;
.. function::  zero abelian-semigroup                              [Function]

   Returns the additive identity of an abelian semigroup.


.. function::    zero? elt                                         [Function]
...
.. function::    coefficient-domain-of module   [Function]
