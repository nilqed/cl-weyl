...
Elements of a free module can be created using the function keylispmake-element. 
...
.. function:: inner-product u v     [Function]
   ...
   Computes the inner (dot product) of the two vectors u and v. If 
   u = (u_1 ... u_k) and v = (v_1 ... v_k) then
  (dot-product u v ) = u_1 v_1 + u_2 v_2 + ... + u_k v_k.
