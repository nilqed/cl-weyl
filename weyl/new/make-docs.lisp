...
(defparameter weyl-folder "/home/kfp/devel/cl-weyl/weyl/")
...
<br>
  ...
  <nav>
    <ul>
      <li><a href=\"https://www.cs.cornell.edu/Info/Projects/SimLab/releases/release-1-0.html\" target=\"_blank\">
         SimLab (Cornell)</a></li>
      <li><a href=\"https://www.cs.cornell.edu/Info/Projects/SimLab/projects/computer-algebra.html\" target=\"_blank\">
         Richard Zippel</a></li>
      ...
      <li><a href=\"https://github.com/nilqed/weyl\" target=\"_blank\">github.com/nilqed/weyl</a></li>
    </ul>
  </nav>
  <main>
  </main>
  <footer>
     <h5>Meta</h5>
     This site was auto-generated by <em>new/make-docs.lisp.</em>
     Loading this file into Lisp and run <em>(create-refman)</em>
     will recreate everything (in docs folder).
     <p>created: ~A</p>
  </footer>
</body>
</html>")
...
(defun create-refman ()
  (progn
    ...
    (create-html-page "index" html-index)
    (create-html-page "nav" html-nav)
    (create-html-page "start" (format nil html-start 
